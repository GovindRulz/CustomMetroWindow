...
namespace CustomMetroWindow
{
    class HListView
    {
        ...
        public static readonly DependencyProperty GenerateColumnsGridViewProperty = DependencyProperty.RegisterAttached("GenerateColumnsGridView", typeof(bool?), typeof(HListView), new FrameworkPropertyMetadata(null, thePropChanged));
        ...
        public static readonly DependencyProperty DateFormatStringProperty = DependencyProperty.RegisterAttached("DateFormatString", typeof(string), typeof(HListView), new FrameworkPropertyMetadata(null));
